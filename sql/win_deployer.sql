...
CREATE TABLE
    IF NOT EXISTS `win_deployer`.`version` (
        ...
        `running_config` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
        `program_config` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
